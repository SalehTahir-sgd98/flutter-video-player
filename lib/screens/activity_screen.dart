    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          CustomHeader(title: 'Startup Sidimisoft'),
...
class _ActivitiesMasonryGrid extends StatelessWidget {
  const _ActivitiesMasonryGrid({Key? key,this.masonryHeights= const [200,250,300], required this.activities,required this.width}) : super(key: key);
